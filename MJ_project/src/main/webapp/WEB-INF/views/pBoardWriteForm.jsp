...
<body>
	...
	<div id="container">
		<form class="form-horizontal" action="./pBoardWrite.do" method="post"
			...
			<div>
				<label class="control-label col-sm-2" for="file">파일</label> <input
					type="file" name="uploadFile">
			</div>
			<div>
				<div>
					<input class="btn btn-success" type="submit" value="글등록"> <input
						class="btn btn-default" type="button" value="목록 이동" onclick="">
				</div>
			</div>
		</form>
	</div>
