...
<!-- ㄴㄴ -->
	...
	<div class="content_wrap">
			...
			<form name="" method="post" action="./Contemplate.do">
				...
				<div data-uc-table="sub2_2">
					...
					<table class="is-table-ver">
						...
						<tr>
							<th>내용</th>
							<td class="is-input-field" id="content" name="content">
								<textarea id="content" name="content" maxlength="3600"></textarea>
							</td>
						</tr>
					</tbody></table>
				</div>
        ...
        <input  class="btn btn-success" type="submit"  value="글 등록">
        <a href="./InquiryController"><input type="button" name="imsi" value="임시등록"></a>
